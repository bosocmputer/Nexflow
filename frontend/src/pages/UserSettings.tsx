...
export default function UserSettings() {
  ...
  return (
    <div className="space-y-5 p-6">
      <PageHeader
        title="ผู้ใช้ระบบ"
        description="เพิ่ม แก้ไข และปิดบัญชีผู้ใช้ ส่วนสิทธิ์เมนูแยกอยู่ในเมนู สิทธิ์เมนู"
        actions={
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/40">
                ...
                <TableHead className="w-[150px]">สิทธิ์หลัก</TableHead>
                ...
                sortedUsers.map((u) => (
                  ...
                  >
                    ...
                    <TableCell className="text-sm text-muted-foreground">
                      {u.id === currentUser.id ? 'กำลังใช้งาน' : 'พร้อมใช้งาน'}
                    </TableCell>
