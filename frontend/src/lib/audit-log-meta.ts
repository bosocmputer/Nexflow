...
export const ACTION_META: Record<string, ActionMeta> = {
  ...
  tiktok_settlement_settings_updated: { label: 'เปลี่ยนการตั้งค่ารับชำระ TikTok Shop', emoji: '⚙️', tone: 'info' },
  tiktok_settlement_preflight_completed: { label: 'ตรวจระบบรับชำระ TikTok Shop พร้อมใช้', emoji: '✅', tone: 'success' },
  ...
  tiktok_settlement_sml_unknown_result: { label: 'ต้องตรวจผลรับชำระ TikTok Shop ใน SML', emoji: '⚠️', tone: 'warning' },
  tiktok_settlement_anomaly: { label: 'พบข้อมูลรับชำระ TikTok Shop ผิดปกติ', emoji: '⚠️', tone: 'danger' },
  // SML push
