export const SHOPEE_ORDER_STATUS_DEFINITIONS = [
  ...
  { value: 'TO_RETURN', label: 'กำลังตีกลับ/รอรับคืน', detail: 'คำสั่งซื้อเข้าสู่ขั้นตอนคืนสินค้าหรือตีกลับ แต่ยังไม่ยืนยันว่าร้านได้รับสินค้า Nexflow จึงยังไม่สร้างเอกสารรับคืนสินค้า/ลดหนี้หรือคืนสต๊อกจากสถานะนี้' },
