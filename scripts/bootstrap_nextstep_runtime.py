...
MARKETPLACE_OPERATIONS_ENABLED=false
TIKTOK_SHOP_GATEWAY_BASE_URL=
TIKTOK_SHOP_GATEWAY_PUBLIC_URL=
TIKTOK_SHOP_GATEWAY_TENANT={target.name}
TIKTOK_SHOP_GATEWAY_INTERNAL_SECRET=
...
VITE_ENABLE_TIKTOK_SHOP_FINANCE=false
VITE_ENABLE_MARKETPLACE_OPERATIONS=false
