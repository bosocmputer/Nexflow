...
func (h *DashboardHandler) Insights(c *gin.Context) {
	featureGone(c, "Daily Insight และ AI ถูกปิดใช้งานแล้ว")
}
...
//
// Returns live SML/LINE status plus compatibility capability flags for cached
// clients. Retired AI and purchase capabilities always remain false.
