...
type APIClient interface {
	...
	GetItemList(ctx context.Context, accessToken string, shopID int64, req ItemListRequest) (*ItemListResponse, error)
	GetItemBaseInfo(ctx context.Context, accessToken string, shopID int64, itemIDs []int64) (*ItemBaseInfoResponse, error)
	GetModelList(ctx context.Context, accessToken string, shopID, itemID int64) (*ModelListResponse, error)
	GetWarehouseDetail(ctx context.Context, accessToken string, shopID int64) (*WarehouseDetailResponse, error)
	UpdateStock(ctx context.Context, accessToken string, shopID int64, req UpdateStockRequest) (*UpdateStockResponse, error)
