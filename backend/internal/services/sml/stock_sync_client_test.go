...
func TestStockSyncClientSendsTenantAndTypedBatch(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = w.Write([]byte(`{"success":true,"data":{"as_of_date":"2026-08-10","scopes":[{"scope_id":"shop:1","items":[{"item_code":"SKU1","item_name":"สินค้า A","unit_code":"กล่อง","balance_qty":12,"excluded_locations":[{"warehouse_code":"W2","warehouse_name":"คลังสำรอง","location_code":"S2","location_name":"ชั้นสอง","unit_code":"กล่อง","balance_qty":-2}]}],"excluded_locations":[{"warehouse_code":"W2","warehouse_name":"คลังสำรอง","location_code":"S2","location_name":"ชั้นสอง","unit_code":"กล่อง","balance_qty":-3}]}],"checked_at":"2026-08-10T00:00:00Z"}}`))
	}))
	defer server.Close()
