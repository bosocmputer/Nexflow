...
func TestApplyShopeePurchaseDiscountsToBillUsesCoinEffectiveDiscount(t *testing.T) {
	...
	mock.ExpectQuery("FROM bill_items").
		...
		WillReturnRows(sqlmock.NewRows([]string{
			"id", "bill_id", "raw_name", "source_sku", "source_item_id", "source_variant_id", "source_line_id", "marketplace_alias_id", "source_image_url", "item_code", "qty", "unit_code", "price",
			...
			AddRow("item-1", billID, "สินค้า A", "", "", "", "line-1", nil, "", "SKU-A", 1.0, "ชิ้น", 100.0, nil, 0.0, true, nil, []byte("[]"), nil, nil, nil, nil, nil, nil, nil, nil, "", []byte("{}"), "").
			AddRow("item-2", billID, "สินค้า B", "", "", "", "line-2", nil, "", "SKU-B", 1.0, "ชิ้น", 200.0, nil, 0.0, true, nil, []byte("[]"), nil, nil, nil, nil, nil, nil, nil, nil, "", []byte("{}"), ""))
	mock.ExpectBegin()
