...
type ChannelDefaultUpsert struct {
	Channel              string `json:"channel" binding:"required,oneof=line email shopee shopee_realtime shopee_realtime_cancel shopee_email shopee_shipped lazada tiktok tiktok_shop tiktok_shop_cancel manual shopee_settlement line_myshop"`
