...
type ShopeeOrderSnapshot struct {
	...
	PaymentBreakdownStatus     string                        `json:"payment_breakdown_status,omitempty"`
...
type ShopeeOrderPaymentSnapshot struct {
	...
	RawEscrow              json.RawMessage `json:"-"`
...
type ShopeeSMLCancellation struct {
	...
	RouteEndpoint          string          `json:"route_endpoint,omitempty"`
	RouteSignature         string          `json:"route_signature,omitempty"`
	...
	StockRecalcAttempts    int             `json:"stock_recalc_attempts,omitempty"`
	...
	ProfilePayloadHash     string          `json:"profile_payload_hash,omitempty"`
	ProfileRequiredChecks  []string        `json:"profile_required_checks,omitempty"`
	ProfileCompletedChecks []string        `json:"profile_completed_checks,omitempty"`
	ProfileNeedsRepair     bool            `json:"profile_reconciliation_required,omitempty"`
	CreatedBy              *string         `json:"created_by,omitempty"`
	CreatedAt              time.Time       `json:"created_at"`
	UpdatedAt              time.Time       `json:"updated_at"`
	CompletedAt            *time.Time      `json:"completed_at,omitempty"`
